...
def simple_demo():
    ...
    while True:
        if not c.cv_image is None:
            c.binary_image = cv2.inRange(np.float32(c.cv_image), (c.blue_lower_bound,c.green_lower_bound,c.red_lower_bound), (c.blue_upper_bound,c.green_upper_bound,c.red_upper_bound))
